...
class ParseSyslogTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        test_files = { 'ubuntu_syslog_small': '../TestLogs/ubuntu_sysint_logs/syslog_small',
                       'ubuntu_syslog_large': '../TestLogs/ubuntu_sysint_logs/syslog',
                       'ubuntu_auth': '../TestLogs/ubuntu_sysint_logs/auth.log', 
                       'ubuntu_kern_small': '../TestLogs/ubuntu_sysint_logs/kern_small.log',
                       'ubuntu_kern': '../TestLogs/ubuntu_sysint_logs/kern.log'}
    ...
    def createEventLexer(self):
        ...
        source_state = LexerState([msg_transition], source_token, False, 'Outer Source State')
    ...
    def createMsgLexers(self):
        ...
        # Precise seconds lexer
        precise_seconds_to_sub_msg_transition = LexerStateTransition('\]', 0, 1, True, sub_msg_state, 'Precise Seconds to Sub Msg Transition')
        precise_seconds_token = Token('precise seconds', Token.SOMETIMES_DATA, True, 'Precise Seconds Token')
        precise_seconds_state = LexerState([precise_seconds_to_sub_msg_transition], precise_seconds_token, False, 'Precise Seconds State')
        precise_seconds_lexer = Lexer(None, 'precise seconds', [], 'Precise Seconds Lexer')
        ...
        msg_state = LexerState([precise_seconds_transition, sub_msg_transition, level_transition, end_transition], msg_token, False, 'Msg State')
        msg_lexer = Lexer(None, 'msg', [], 'Msg Lexer')
        
        return ((msg_lexer, precise_seconds_lexer, level_lexer, sub_msg_lexer), msg_state)
